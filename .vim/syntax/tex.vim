...
if !exists("g:tex_no_math") && !exists("s:tex_no_error")
 ...
 syn match texBadMath		"\\end\s*{\s*\(align\|alignat\|displaymath\|displaymath\|eqnarray\|equation\|myequation\|flalign\|gather\|math\|multline\|xalignat\)\*\=\s*}"
...
if !exists("tex_no_math")
 ...
 call TexNewMathZone("M","myequation",0)
